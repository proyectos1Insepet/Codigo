    ...
    switch(flowDisplay1){
        ...
        case 5: //Seleccion de producto
            ...
            if(side.a.GradesHose[0] !=0)
            {
                for(x = 0; x < 10; x++)
                {
                   WriteMessage(1, producto1[x],11,7+x,2,0xFFFF,'Y'); //WriteMessage(1, producto[side.a.GradesHose[0]-1][x],11,7+x,2,0xFFFF,'Y');
                } 
            }
    ...
    switch(flowDisplay3){
        ...
        case 1: //Menu   
            if(Display1_GetRxBufferSize() == 8)
            {
                if((Display1_rxBuffer[0] == 0xAA) && (Display1_rxBuffer[6] == 0xC3) && (Display1_rxBuffer[7] == 0x3C))
                {                                             
                    flowDisplay3 = 2;                               //Pantalla forma de pago                      
                    SetPicture(1, DISPLAY_FORMA_PAGO_DESEADA);
                    vTaskDelay( 10 / portTICK_PERIOD_MS );
                    Display1_ClearRxBuffer();
                }  
        ...
        case 5: //Seleccion de producto
            ...
            if(side.c.GradesHose[1] !=0)
            {
                for(x = 0; x < 10; x++)
                {
                    WriteMessage(1, producto[side.c.GradesHose[1]-1][x],17,8+x,2,0xFFFF,'Y');
                } 
            }
            if(side.c.GradesHose[2] !=0)
            {
                for(x = 0; x < 10; x++)
                {
                    WriteMessage(1, producto[side.c.GradesHose[2]-1][x],23,9+x,2,0xFFFF,'Y');
                } 
            }
            if(side.c.GradesHose[3] !=0)
            {
                for(x = 0; x < 10; x++)
                {
                    WriteMessage(1, producto[side.c.GradesHose[3]-1][x],29,10+x,2,0xFFFF,'Y');
                } 
            }
                    ...
                    switch(Display1_rxBuffer[3])
                    {
                        ...
                        case 0xB5:  //Copia de recibo 
                            if(lockTurn == 1)
                            {
                                ...
                                side.c.rfState = RF_COPY_RECEIPT;
                                SetPicture(1,DISPLAY_IMPRIMIENDO_RECIBO); 
                                vTaskDelay( 900 / portTICK_PERIOD_MS );
                                flowDisplay3  = 0;                                                                                                 
                            }else
    ...
    switch(flowDisplay4){
        ...
        case 1: //Menu                        
            if(Display2_GetRxBufferSize() == 8)
            {
                if((Display2_rxBuffer[0] == 0xAA) && (Display2_rxBuffer[6] == 0xC3) && (Display2_rxBuffer[7] == 0x3C))
                {                                             
                    flowDisplay4 = 2;                          //Pantalla forma de pago                      
                    SetPicture(2,DISPLAY_FORMA_PAGO_DESEADA);   
                    vTaskDelay( 10 / portTICK_PERIOD_MS );
                    Display2_ClearRxBuffer();
                }                 
        ...
        case 5: //Menu de seleccion de producto
            if(side.d.GradesHose[0] !=0)
            {
                for(x = 0; x < 10; x++)
                {
                    WriteMessage(2, producto[side.d.GradesHose[0]-1][x],11,7+x,2,0xFFFF,'Y');
                } 
            }
            if(side.d.GradesHose[1] !=0)
            {
                for(x = 0; x < 10; x++)
                {
                    WriteMessage(2, producto[side.d.GradesHose[1]-1][x],17,8+x,2,0xFFFF,'Y');
                } 
            }
            if(side.d.GradesHose[2] !=0)
            {
                for(x = 0; x < 10; x++)
                {
                    WriteMessage(2, producto[side.d.GradesHose[2]-1][x],23,9+x,2,0xFFFF,'Y');
                } 
            }
            if(side.d.GradesHose[3] !=0)
            {
                for(x = 0; x < 10; x++)
                {
                    WriteMessage(2, producto[side.d.GradesHose[3]-1][x],29,10+x,2,0xFFFF,'Y');
                } 
            }
            if(Display2_GetRxBufferSize() == 8)
            {
                    ...
                    switch(Display2_rxBuffer[3])
                    {
                        ...
                        case 0xB5:  //Copia de recibo 
                            if(lockTurn == 1)
                            {
                                ...
                                side.d.rfState = RF_COPY_RECEIPT;
                                SetPicture(2,DISPLAY_IMPRIMIENDO_RECIBO); 
                                vTaskDelay( 900 / portTICK_PERIOD_MS );
                                flowDisplay4  = 0;
                                Display2_ClearRxBuffer();
        ...
        if(Credit_Auth_OK == 1 && AuthType == 1)
        {
            ...
            {   
                ...
                {                                     
                    ...
                    ShowMessage(1, (bufferDisplay1.CreditpresetValue[1]), 18);
                    flowDisplay1 = 8;
                    PresetFlag = 0;
                    AuthType = 0;
                    Credit_Auth_OK = 0;
           ...
           //Venta en efectivo
            ...
            {       
                ...
                {   
                        //Actualiza precios por el almacenado en la memoria
                        ReadPPUFromEEprom();
                        priceChange(side.c.dir, side.c.activeHose, side.c.ppuAuthorized[side.c.grade]);
                        
                        // PRESET
                        if(PresetData(side.c.dir, side.c.activeHose, bufferDisplay3.presetValue[0], bufferDisplay3.presetType[0] & 0x03) == 1)
                        {                                           
                            get_state(side.c.dir);        
                            //Authorize
                            Authorization(side.c.dir);                                                         
        ...
        if(PresetFlag4 == 1)
        {
            ...
            {   
                ...
                {   
                    ...
                    if(PresetData(side.d.dir, side.d.activeHose, bufferDisplay4.presetValue[0], bufferDisplay4.presetType[0] & 0x03) == 1)
                    {                    
                        get_state(side.d.dir);
                        //Authorize
                        Authorization(side.b.dir);
                        ...
                        SetPicture(2, DISPLAY_DESPACHANDO); 
                        flowDisplay4 = 8;
                        ShowMessage(2, (bufferDisplay4.presetValue[0]), 18);
                        PresetFlag4 = 0;  
                        return;                
